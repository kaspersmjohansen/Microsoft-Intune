...
Try {
    ...
    [String]$appScriptDate = '01/05/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install -Path '7-Zip_24.06_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-MSIApplications -Name '7-Zip*' -Wildcard
