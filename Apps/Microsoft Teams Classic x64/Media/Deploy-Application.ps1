...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install 'Microsoft Teams classic_1.7.00.10152_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart ALLUSERS=1'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-MSIApplications -Name 'Teams Machine-Wide Installer' -Exact
