...
Try {
    ...
    [String]$appName = 'Visual C++ 2010 x86 Redistributable'
    [String]$appVersion = ''
    [String]$appArch = 'x86'
    [String]$appLang = 'EN'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Microsoft Visual C++ 2010*.exe' -Parameters '/q /norestart'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-MSIApplications -Name 'Microsoft Visual C++ 2010  x86 Redistributable*' -Wildcard
