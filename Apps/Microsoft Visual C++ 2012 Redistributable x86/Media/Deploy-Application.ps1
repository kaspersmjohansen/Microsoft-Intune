...
Try {
    ...
    [String]$appName = 'Visual C++ 2012 Redistributable'
    [String]$appVersion = ''
    [String]$appArch = 'x86'
    [String]$appLang = 'EN'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path 'C:\ProgramData\Package Cache\{33d1fd90-4274-48a1-9bc1-97e33d9c2d6f}\vcredist_x86.exe' -Parameters '/uninstall /quiet /norestart'
