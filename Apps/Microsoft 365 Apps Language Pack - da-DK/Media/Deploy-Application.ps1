...
Try {
    ...
    [String]$appName = '365 Apps Language Pack - da-DK'
    [String]$appVersion = ''
    [String]$appArch = ''
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '22/09/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        #Invoke-WebRequest -UseBasicParsing -Uri $SourceURL -OutFile "$dirFiles\setup.exe"
        Start-BitsTransfer -Source "https://officecdn.microsoft.com/pr/wsus/setup.exe" -Destination "$dirFiles\setup.exe" -TransferType Download
        ...
        Execute-Process -Path 'setup.exe' -Parameters "/configure `"$dirSupportFiles\Install.xml`""
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path 'setup.exe' -Parameters "/configure `"$dirSupportFiles\Uninstall.xml`""
