...
Try {
    ...
    [String]$appScriptDate = '27/11/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        {
	        Write-Log "Enable Windows Sandbox"
	        Enable-WindowsOptionalFeature -Online -FeatureName Containers-DisposableClientVM -All -Online -NoRestart
        }
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        If ((Get-WindowsOptionalFeature -Online -FeatureName 'Containers-DisposableClientVM').State -eq 'Installed')
        {
	        Write-Log "Disable Windows Sandbox"
