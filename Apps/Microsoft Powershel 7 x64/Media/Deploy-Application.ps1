...
Try {
    ...
    [String]$appName = 'Poweshell 7'
    [String]$appVersion = ''
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '30/05/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install -Path 'PowerShell_7.4.2.0_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart'
