...
Try {
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Write-Log "Removing Interactive User from the local Hyper-V Administrators group"
        Remove-LocalGroupMember -Group "Hyper-V Administrators" -Member S-1-5-4
