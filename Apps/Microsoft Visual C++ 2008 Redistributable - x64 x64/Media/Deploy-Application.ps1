...
Try {
    ...
    [String]$appName = 'Visual C++ 2008 Redistributable - x64'
    [String]$appVersion = ''
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Microsoft Visual C++ 2008 Redistributable*.exe' -Parameters '/q'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-MSIApplications -Name 'Microsoft Visual C++ 2008 Redistributable - x64*' -Wildcard
