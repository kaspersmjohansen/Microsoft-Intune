...
Try {
    ...
    [String]$appName = 'Visual C++ 2005 Redistributable'
    [String]$appVersion = ''
    [String]$appArch = 'x86'
    [String]$appLang = 'EN'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Microsoft Visual C++ 2005 Redistributable*' -Parameters '/Q'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-MSIApplications -Name 'Microsoft Visual C++ 2005 Redistributable' -Exact
