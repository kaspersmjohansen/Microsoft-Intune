...
Try {
    ...
    [String]$appScriptDate = '13/09/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install 'Microsoft Teams classic_1.7.00.24670_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart ALLUSERS=1'
