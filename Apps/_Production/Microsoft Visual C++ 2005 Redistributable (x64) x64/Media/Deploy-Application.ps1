...
Try {
    ...
    [String]$appName = 'Visual C++ 2005 Redistributable (x64)'
    [String]$appVersion = ''
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '17/05/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Microsoft Visual C++ 2005 Redistributable (x64)_8.0.61000_Machine_X64_exe_en-US.exe' -Parameters '/Q'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-MSIApplications -Name 'Microsoft Visual C++ 2005 Redistributable (x64)' -Exact
