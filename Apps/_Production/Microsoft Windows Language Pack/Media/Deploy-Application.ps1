...
Try {
    ...
    [String]$appName = 'Windows Language Pack - DK'
    [String]$appVersion = ''
    [String]$appArch = ''
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '23/06/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        # Set keyboard layout
        Copy-File -Path "$dirSupportFiles\set-oslanguage.ps1" -Destination "$env:ProgramData\KeyboardLayout"
        Set-ActiveSetup -StubExePath "$env:systemroot\system32\WindowsPowerShell\v1.0\powershell.exe" -Arguments "-executionpolicy bypass -file $env:ProgramData\KeyboardLayout\set-oslanguage.ps1" -Description 'Set OS Language' -Key 'OS Language' -ContinueOnError $true -ExecuteForCurrentUser $false
