...
Try {
    ...
    [String]$appName = 'Visual C++ 2015-2022 Redistributable (x86)'
    [String]$appVersion = ''
    [String]$appArch = ''
    [String]$appLang = 'EN'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Microsoft Visual C++ 2015-2022 Redistributable (x86)*.exe' -Parameters '/install /quiet /norestart'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path 'Microsoft Visual C++ 2015-2022 Redistributable (x86)*.exe' -Parameters '/uninstall /quiet /norestart'
