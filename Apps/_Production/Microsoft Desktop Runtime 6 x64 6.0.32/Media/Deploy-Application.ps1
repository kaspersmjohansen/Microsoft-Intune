...
Try {
    ...
    [String]$appName = 'Desktop Runtime 6'
    [String]$appVersion = ''
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '29/07/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Microsoft .NET Windows Desktop Runtime*.exe' -Parameter "/install /quiet /norestart /log `"$configToolkitLogDir\$($appVendor+"_"+$appName+"_"+"Install"+".log")`""
