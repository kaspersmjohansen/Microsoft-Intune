...
Try {
    ...
    [String]$appName = 'Visual C++ 2013 Redistributable x64'
    [String]$appVersion = ''
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Microsoft Visual C++ 2013*' -Parameters '/install /quiet /norestart'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path 'C:\ProgramData\Package Cache\{042d26ef-3dbe-4c25-95d3-4c1b11b235a7}\vcredist_x64.exe' -Parameters '/uninstall /quiet /norestart'
