...
Try {
    ...
    [String]$appScriptDate = '22/06/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'chrome' -CheckDiskSpace
        ...
        Execute-MSI Install -Path 'Google Chrome_126.0.6478.115_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart'
        ...
        Remove-File -Path "$env:USERPROFILE\Desktop\Google Chrome.lnk"
