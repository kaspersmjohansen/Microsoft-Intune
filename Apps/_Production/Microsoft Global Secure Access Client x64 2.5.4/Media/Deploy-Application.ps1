...
Try {
    ...
    [String]$appScriptDate = '12/09/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'GlobalSecureAccess*.exe' -Parameters "/install /quiet /norestart /log `"$configToolkitLogDir\$($appVendor+"_"+$appName+"_"+"Install"+".log")`""
        ...
        Register-ScheduledTask -Action $action `
                            -Trigger $trigger `
                            -TaskName "Kerberos Negative Cache Reset" `
                            -Description "Kerberos Negative Cache Reset is a workaround for the Global Secure Access Client to remediate domain controller bypass - Additional information - https://mortenknudsen.net/?p=2965" `
                            -Principal $STPrin
        #>
