...
Try {
    ...
    [String]$appScriptDate = '08/08/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'Git_2.46.0_Machine_X64_inno_en-US.exe' -Parameters "/VERYSILENT /NORESTART /LOG=`"$configToolkitLogDir\$($appVendor+"_"+$appName+"_"+"Install"+".log")`""
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path "$env:ProgramFiles\Git\unins000.exe" -Parameters "/VERYSILENT /NORESTART /LOG=`"$configToolkitLogDir\$($appVendor+"_"+$appName+"_"+"Uninstall"+".log")`""
