...
Try {
    ...
    [String]$appName = 'Powershell 7'
    [String]$appVersion = ''
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '26/10/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install -Path 'PowerShell_7.4.6.0_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart USE_MU=1 ENABLE_MU=1'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-MSIApplications -Name 'PowerShell 7-x64' -Exact
