...
Try {
    ...
    [String]$appScriptDate = '21/09/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install 'Microsoft Teams classic_1.7.00.26062_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart ALLUSERS=1'
