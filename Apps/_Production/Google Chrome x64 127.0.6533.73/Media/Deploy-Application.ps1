...
Try {
    ...
    [String]$appScriptDate = '27/07/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install -Path 'Google Chrome_127.0.6533.73_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart'
        ...
        Copy-File -Path "$dirSupportFiles\master_preferences" -Destination "$env:ProgramFiles\Google\Chrome\Application\master_preferences"
