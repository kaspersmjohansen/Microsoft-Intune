...
Try {
    ...
    [String]$appScriptDate = '22/08/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install -Path 'PowerShell_7.4.5.0_Machine_X64_wix_en-US.msi' -Parameters '/qn /norestart USE_MU=1 ENABLE_MU=1'
