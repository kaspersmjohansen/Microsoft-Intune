...
Try {
    ...
    [String]$appName = '.NET Framework - Offline'
    [String]$appVersion = '3.5'
    [String]$appArch = ''
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '22/05/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        If ((Get-WindowsOptionalFeature -FeatureName 'NetFx3' -Online).State -ne 'Enabled')
        {
	        ...
	        Enable-WindowsOptionalFeature -FeatureName NetFx3 -All -Online -NoRestart -Source $dirFiles -LimitAccess -LogPath $configToolkitLogDir\$($appVendor+"_"+$appName+"_"+"DISM"+"_"+"Install"+".log") -LogLevel Debug
        }
