...
Try {
    ...
    [String]$appName = 'GIMP for Windows'
    [String]$appVersion = ''
    [String]$appArch = ''
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '04/10/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'GIMP*.exe' -Parameters "/VERYSILENT /NORESTART /ALLUSERS /MERGETASKS=`"desktopicon`" /LOG=`"$configToolkitLogDir\$($appVendor+"_"+$appName+"_"+"Install"+".log")`""
        ...
        Remove-File -Path "$env:PUBLIC\Desktop\GIMP 2.*.lnk"
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path "$env:ProgramFiles\GIMP 2\uninst\unins000.exe" -Parameters '/VERYSILENT /NORESTART'
