...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'OBS Studio_*.exe' -Parameters '/S'
        ...
        Remove-File -Path "$env:PUBLIC\Desktop\OBS Studio.lnk"
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path "$env:ProgramFiles\obs-studio\uninstall.exe" -Parameters '/S'
