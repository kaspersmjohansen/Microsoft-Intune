...
# Detect Windows language pack
$LanguagePack = "true"

# Detect Windows language pack language
$LanguagePackID = "da-DK"
...
If ($LanguagePack -eq "True")
{
    If (Get-InstalledLanguage -Language $LanguagePackID)
    {
        Write-Host "Found it!"
    }
}