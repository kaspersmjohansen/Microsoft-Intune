...
Try {
    ...
    [String]$appName = 'Visual C++ 2013 Redistributable'
    [String]$appVersion = ''
    [String]$appArch = 'x86'
    [String]$appLang = 'EN'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path 'C:\ProgramData\Package Cache\{9dff3540-fc85-4ed5-ac84-9e3c7fd8bece}\vcredist_x86.exe' -Parameters '/uninstall /quiet /norestart'
